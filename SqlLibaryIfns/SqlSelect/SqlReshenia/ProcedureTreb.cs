...
namespace SqlLibaryIfns.SqlSelect.SqlReshenia
{
   public class ProcedureReshenie
   {
       ...
       public static readonly string SqlFullTreb = @"Select doc.D865 as 'Ун решения',
                                                            ...
                                                            --cash.N89 as 'Расчетный счет'
                                                               From (Select fn1596.d865,fn1517.D270, fn1577.N1, sum (fn1500.d512) as 'Остаток', FN1016.D82,fn1517.D851,fn1517.D850,FN1016.D81,FN1016.D430,FN1519.N120,FN1517.D1967,fn1517.D09,DATEDIFF(day, dateadd(day, isnull(fn1044.d2320,0)-1, FN1517.D1967), getdate()) as colday From Fn1500
                                                                    Left join fn1596 (nolock) on fn1500.d307 = fn1596.d307 and fn1596.d307 not in (select d307 from Taxes51..fn1596
                                                                                                                                                      Left Join fn1182 on fn1596.d865 =  fn1182.D865
                                                                                                                                                      Left Join FN1016 d on d.D81 = fn1182.D81
                                                                                                                                                   where D2578 in (3,9,20) --ИП или арест имущества или решение 185
                                                                                                                                                         and D785=0  --неисполненные ИП и решения не вышибают недоимки !
                                                                                                                                                         or (d.D430 = 2427 and fn1596.d865 not in (select t2427.d865 from Taxes51..fn1517 t2427 
	                                                                                                                                                                                                  join Taxes51..fn1517 r185 on t2427.d851 = r185.d851_2)))
                                                    ...
                                                    join (select distinct fn212.n1,fn212.N18
                                                          from fn212 (nolock)
                                                  ...
                                                  Where a.D851_2 is NULL  and doc.D09<>1 and doc.D1967<GETDATE() and doc.colday<365 and doc.colday>-55";
       ...
       public static readonly string SelectReshenie = @"Select * From TableSysNumReshen
                                                        ...
                                                        Left Join Incass on Incass.D851Res_1 = Reshenie.D851Res 
                                                        where TableSysNumReshen.DataCreate BETWEEN @D85DateStart and @D85DateFinish
                                                        FOR XML AUTO,ROOT('SysNum')";
        /// <summary>
        /// Процедура AddTreb
        /// </summary>
