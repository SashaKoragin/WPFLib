...
namespace LibaryAIS3Windows.Mode
{
    /// <summary>
    ...
    /// Сдесь объявлены кнопки управление 0 текст 1 название на кнопки
    /// </summary>
    internal class SnuForm
    {
        /// <summary>
        /// Кнопка Тип заявки
        /// </summary>
        ...
        /// Кнопка обновить
        /// </summary>
        internal static string[] ButUpdate =
        {
            "Обновить",
            "[NAME:button1]"
        };
        ...
        /// Кнопка далее
        /// </summary>
        internal static string[] ButNext =
        {
            "Далее",
            "[NAME:btnOk]"
        };
        ...
        /// Кнопка Отмена
        /// </summary>
        internal static string[] ButCancel =
        {
            "Отмена",
            "[NAME:btnCancel]"
        };
        ...
        /// </summary>
        internal static string[] ButCreateZ =
        {
            "Создать заявку",
            "[NAME:but_Create]"
        };
